...
TELEGRAM_PUBLISH_CHANNEL_ID = _optional("TELEGRAM_PUBLISH_CHANNEL_ID", "")
TELEGRAM_BOT_PUBLIC_LINK = _optional(
    "TELEGRAM_BOT_PUBLIC_LINK",
    _optional("NEXT_PUBLIC_TELEGRAM_BOT_LINK", ""),
)
